...
var Aiml = function(file) {
    ...
    // replaces the think vars in the text
    ...
    this.respond = function( item ) {
        ...
        if (item.think) self.set_vars( item ); // it think, the vars should be set
    ...
    // don't know if I still use that
