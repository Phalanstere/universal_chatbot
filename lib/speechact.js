    ...
    this.identity_clause = function() {
        ...
        var seq = {
                   ...
                   sequence: [
                        ...
                        pattern:     {
                                    sequence: [
                                                { type: HAVE, optional: true, desc: "first_auxiliary" },                                                
                                                { type: AUXILIARY, optional: false, desc: "auxiliary" },
        ...
        if (res.length > 0) self.mark_elements(res, "identity_clause", 0);
        return res;
...
;
        ...
        else debugs("Hauptsatz ist undefiniert");
