...
var SpeechAct = function() {
    ...
    this.check_relative_pronouns = function() {
        ...
        if (x) {
            debugr("Relativ-Pronomen gefunden");
   ...
   this.new_adverbial_clause = function( solution ) {
        ...
        var offset = 0;
        for (var i = 0; i < self.sequence.length; i++) {
            var it = self.sequence[i];
            if (it === solution.it.word) debugc("Neues Wort");
        }

       debugc ("Der neue Adverbial Clause");
        ...
        debugc("Der Offset steht bei " + solution.offset);
    ...
    this.relative_clause = function() {
        ...
        debugr("a relative pronoun is defined");
    ...
    this.mark_adverbial_clause = function( solution, offset) {
        debuga("sollte den CLAUSE markieren");
