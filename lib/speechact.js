...
var SpeechAct = function() {
        ...
        if (self.sequence[ pos + 1 ]) {
            ...
            if ( item.type === "preposition") {
                if (self.sequence[pos + 3] ) {
                    ...
                    if (art.type === "article" || art === "possessive" && obj.noun) {
                    ...
                    {
                        spa( obj );
                        spa("komplizierte Konstruktion");
                        var adj = obj;
                        if (adj.type === "adjective" || art === "possessive" && self.sequence[pos + 4]) {
    ...
    this.check_speechacts = function() {
        ...
        if (! self.act.predicate) self.find_probable_predicate();
